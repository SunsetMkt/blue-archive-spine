...
class Texture2D(Texture):
	...
	def image(self):
		...
		if self.format in (TextureFormat.DXT1, TextureFormat.DXT1Crunched):
			...
			args = (7, )
		# 4 5 6 8 10 12
		elif self.format == TextureFormat.ASTC_RGB_4x4:
			codec = "astc"
			args = (4, 4, False)
		elif self.format == TextureFormat.ASTC_RGB_5x5:
			codec = "astc"
			args = (5, 5, False)
		elif self.format == TextureFormat.ASTC_RGB_6x6:
			codec = "astc"
			args = (6, 6, False)
		elif self.format == TextureFormat.ASTC_RGB_8x8:
			codec = "astc"
			args = (8, 8, False)
		elif self.format == TextureFormat.ASTC_RGB_10x10:
			codec = "astc"
			args = (10, 10, False)
		elif self.format == TextureFormat.ASTC_RGB_12x12:
			codec = "astc"
			args = (12, 12, False)
		
		elif self.format == TextureFormat.ASTC_RGBA_4x4:
			codec = "astc"
			args = (4, 4, True)
		elif self.format == TextureFormat.ASTC_RGBA_5x5:
			codec = "astc"
			args = (5, 5, True)
		elif self.format == TextureFormat.ASTC_RGBA_6x6:
			codec = "astc"
			args = (6, 6, True)
		elif self.format == TextureFormat.ASTC_RGBA_8x8:
			codec = "astc"
			args = (8, 8, True)
		elif self.format == TextureFormat.ASTC_RGBA_10x10:
			codec = "astc"
			args = (10, 10, True)
		elif self.format == TextureFormat.ASTC_RGBA_12x12:
			codec = "astc"
			args = (12, 12, True)
		else:
			codec = "raw"
